...
class FileSystemTest extends TestCase
{
    ...
    {
        $expectedPath = __DIR__ . '/resources/storage/28-Apr-2018/thumbnail_1_test.jpg';
    ...
    public function testGetPathToThumnailWithBadFile()
    {
        $file = new File (['safe_name' => 'file_does_not_exist.jpg']);
        $file->id = 1;
        $file->uploaded = '2018-04-28 19:48:18.183528';
        $this->expectException(FileSystemException::class);
        $this->fileSystem->getPathToThumbnail($file);
    }
}